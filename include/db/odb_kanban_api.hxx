...
public:
  ...
  core::Id createBoard(const std::string &name,
  ...
  std::vector<core::TaskDto> listTasksForBoard(core::Id boardId,
                                               bool includeArchived) override;
  std::vector<core::TaskDto> listTasksForColumn(core::Id columnId,
                                                bool includeArchived) override;

  core::Id createTask(core::Id boardId, core::Id columnId,
  ...
  void
  setTasksOrderForColumn(core::Id columnId,
                         const std::vector<core::Id> &orderedTaskIds) override;

  std::vector<core::CategoryDto> listCategories(core::Id boardId) override;
  core::Id createCategory(core::Id boardId, const std::string &name,
                          const std::string &color) override;
  void deleteCategory(core::Id categoryId) override;
  void setTaskCategory(core::Id taskId,
                       std::optional<core::Id> categoryId) override;
