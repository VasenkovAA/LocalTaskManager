...
static constexpr const char *kColumnMime =
    "application/x-localtaskmanager-column";

class KanbanColumnWidget final : public QWidget {
  Q_OBJECT
public:
  explicit KanbanColumnWidget(unsigned long boardId, unsigned long columnId,
...
signals:
  ...
  void columnMoveRequested(unsigned long fromColumnId, unsigned long toColumnId,
                           bool insertBefore);
